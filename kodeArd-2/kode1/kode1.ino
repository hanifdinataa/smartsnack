// =====================================================================
//  SMART SNACK BOX — ESP32 FIRMWARE (KALIBRASI & DIVERIFIKASI FITUR FULL)
//
//  Hardware Pinout:
//    - Ultrasonik HC-SR04 : Trig=26, Echo=27
//    - Timbangan HX711   : DT=32, SCK=33
//    - Servo Box          : GPIO 18
//    - Buzzer             : GPIO 19
//    - LCD 16x2 I2C       : SDA=21, SCL=22 (Alamat 0x27)
//    - Suhu MLX90614      : SDA=21, SCL=22
//    - Detak Jantung      : MAX30102 (SDA=21, SCL=22)
// =====================================================================
...
// ===== KALIBRASI SENSOR (Sama Persis dengan kodeArduinoBerhasil.txt) =====
...
float measureWeightKg(String& errorCode) {
  ...
  float b = scale.get_units(5);
  if (b < 0) b = 0;
  Serial.print("Hasil Berat: "); Serial.println(b, 2);
  return b;
}
...
void loop() {
  ...
  // 3. Continuous Background Sampling for Load Cell (Berat)
  if (scale.is_ready()) {
